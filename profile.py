...
results['tf-cpu'] = timeit.timeit('sess.run(prmsd)', number=2, globals=globals())
results['mdtraj'] = timeit.timeit('[md.rmsd(traj, traj, i) ** 2 for i in range(traj.n_frames)]', number=2, globals=globals())
